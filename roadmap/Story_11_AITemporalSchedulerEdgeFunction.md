...
2.  **Embed Parsing Logic:** Program the system prompts in [`aiagent.md`](../aiagent.md) Section 3.2. Teach the engine to identify the core appointment anchor, parse natural language offset keywords (e.g. _"10h before"_, _"45 mins after"_), and translate them to negative/positive minutes offsets.
...
1.  Sending raw prompt _"Flight on Friday at 8am, pack bags 12h before"_ returns structured JSON with an anchor at `08:00` and a child task with `offsetMinutes: -720`.
