...
2.  **Display Warning Dialogs:** Trigger the confirmation friction modal:
    - Show a clear description of the boundary breach (e.g. _"Rosa is currently off-shift"_ or _"It is currently her Rest Day"_).
    - Detail the cost in Rest Owed (e.g. _"Proceeding will log 30 minutes of Rest Owed to her ledger"_).
