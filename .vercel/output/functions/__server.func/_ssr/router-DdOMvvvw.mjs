...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DdOMvvvw.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-BwXFrKUj.css";
...
var Route$1 = createRootRouteWithContext()({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Linara helps families and household helpers coordinate the day with calm, shared clarity."
			},
			{
				property: "og:title",
				content: "Linara — Home, made clear."
			},
			{
...
var $$splitComponentImporter = () => import("./routes-DYekiw7v.mjs");
